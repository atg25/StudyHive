...
// Split TOS into paragraphs
var paragraphs = tosText.split("\n\n");
var htmlOutput = "";

// Loop through paragraphs and format as HTML
for (var i = 0; i < paragraphs.length; i++) {
  var paragraph = paragraphs[i];

  // Check if this is a numbered section (like "1. PURPOSE OF THE PLATFORM")
  ...
  // Check if this is the intro paragraph
    ...
    htmlOutput = htmlOutput + '<p class="tos-intro">' + paragraph + "</p>";
  }
  // Regular paragraph
  else {
    htmlOutput = htmlOutput + '<p class="tos-para">' + paragraph + "</p>";
  }
}
